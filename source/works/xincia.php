...
<div class="left gallery_desc">
        ...
        <h3 class="margintop20"><strong>Blue Dragon and Clouds</strong><br/>
        Motion Experiment</h3>
        
    <p class="margintop10">This video was created to refresh my abilities (especially the 3D Camera effect) while greeting my friends who were celebrating Chinese New Year.</p>
        ...
        <div class="clear"></div>
         ...
         <p class="margintop20"><a href="dts.php">Next Project</a></p>
        

</div>

<div class="left gallery_video">
    <iframe src="http://player.vimeo.com/video/17045679?byline=0&amp;portrait=0" width="900" height="506" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
    </div>
</div> <!--project end-->
</section>
