...
RT.VIEWS.MAIN = (function(window){
	...
	main.preload = function(){
		...
		$("#graphic-design-load").appear(function(){
			loadModule(this, "views/partials/graphic-design.html");
		});

		$("#web-interactive-load").appear(function(){
			loadModule(this, "views/partials/web-interactive.html")
		});

		$("#motion-audio-load").appear(function(){
			loadModule(this, "views/partials/motion-audio.html")
		});

		$("#photography-load").appear(function(){
			loadModule(this, "views/partials/photography.html")
		});
	}
